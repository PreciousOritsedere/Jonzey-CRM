...
import {
  ...
  setRefetch,
  deleteItemsByIds,
} from '../../stores/tenant/tenantSlice';
import { useAppDispatch, useAppSelector } from '../../stores/hooks';
import { useRouter } from 'next/router';
import { Field, Form, Formik } from 'formik';
import { DataGrid, GridColDef } from '@mui/x-data-grid';
import { loadColumns } from './configureTenantCols';
...
const TableSampleTenant = ({
  ...
  useEffect(() => {
    if (tenantNotify.showNotification) {
      notify(tenantNotify.typeNotification, tenantNotify.textNotification);
    }
  }, [tenantNotify.showNotification]);
  ...
  const handleViewAction = (id: string) => {
    router.push(`/tenant/tenant-view/?id=${id}`);
  };
...
export default TableSampleTenant;
