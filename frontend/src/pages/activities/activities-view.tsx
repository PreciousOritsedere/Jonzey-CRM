      ...
      <SectionMain>
        ...
        <CardBox>
            ...
            {activities.date ? (
              <DatePicker
                ...
                selected={
                  activities.date
                    ? new Date(
                        dayjs(activities.date).format('YYYY-MM-DD hh:mm'),
                      )
                    : null
                }
                disabled
          ...
          <FormField label='Multi Text' hasTextareaHeight>
            <textarea className={'w-full'} disabled value={activities?.notes} />
          </FormField>

          <div className={'mb-4'}>
            <p className={'block font-bold mb-2'}>RelatedTo</p>

            <p>{activities?.related_to?.email ?? 'No data'}</p>
          </div>
          ...
          <div className={'mb-4'}>
            ...
            <p>{activities?.tenant?.name ?? 'No data'}</p>
          </div>
