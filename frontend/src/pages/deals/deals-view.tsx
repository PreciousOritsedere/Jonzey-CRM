    ...
    <>
      ...
      <SectionMain>
        <SectionTitleLineWithButton
          ...
          title={removeLastCharacter('View deals')}
          main
        >
          {''}
        </SectionTitleLineWithButton>
...
DealsView.getLayout = function getLayout(page: ReactElement) {
  return (
    <LayoutAuthenticated permission={'READ_DEALS'}>{page}</LayoutAuthenticated>
  );
};
