      ...
      <SectionMain>
        ...
        <CardBox>
          ...
          <div className={'mb-4'}>
            ...
            <p>{users?.tenant?.name ?? 'No data'}</p>
          </div>

          <>
            <p className={'block font-bold mb-2'}>Activities Owner</p>
            <CardBox
              className='mb-6 border border-gray-300 rounded overflow-hidden'
              hasTable
            >
              <div className='overflow-x-auto'>
                <table>
                  ...
                  <tbody>
                    {users.activities_owner &&
                      Array.isArray(users.activities_owner) &&
          ...
          <>
            <p className={'block font-bold mb-2'}>Contacts Owner</p>
            <CardBox
              className='mb-6 border border-gray-300 rounded overflow-hidden'
              hasTable
            >
              <div className='overflow-x-auto'>
                <table>
                  ...
                  <tbody>
                    {users.contacts_owner &&
                      Array.isArray(users.contacts_owner) &&
          ...
          <>
            <p className={'block font-bold mb-2'}>Deals Owner</p>
            <CardBox
              className='mb-6 border border-gray-300 rounded overflow-hidden'
              hasTable
            >
              <div className='overflow-x-auto'>
                <table>
                  ...
                  <tbody>
                    {users.deals_owner &&
                      Array.isArray(users.deals_owner) &&
